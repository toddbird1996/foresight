  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6">
        ...
        {userProfile && !userProfile.case_status && userProfile.situation && (
          <div className="mb-4 bg-white border-2 border-red-200 rounded-2xl p-4 shadow-sm">
...
const WALKTHROUGH = {
  ...
  preparing: {
    ...
    steps: [
      ...
      { title: "Complete Parenting After Separation course", desc: "Mandatory for any case involving children. Must be done BEFORE filing. Register at saskatchewanforkidssake.ca.", link: 'https://www.saskatchewanforkidssake.ca/', linkLabel: 'Register Now', mandatory: true, detail: "~$25 · Takes a few hours · You get a certificate to attach to your filing" },
  ...
  responding: {
    ...
    steps: [
      ...
      { title: "Complete Parenting After Separation if children are involved", desc: "Even as a respondent, you must complete this course. Register at saskatchewanforkidssake.ca.", link: 'https://www.saskatchewanforkidssake.ca/', linkLabel: 'Register', mandatory: true },
