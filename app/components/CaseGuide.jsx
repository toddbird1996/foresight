...
const CASE_STAGES = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { key: 'fdr_find', label: 'Find a mediator (FDR provider)', detail: 'You need a trained FDR mediator to run the session. Go to the Programs page to find mediation services in your province. SK: Saskatchewan Dispute Resolution Office — 306-787-5747, sliding-scale fees available.', link: '/programs', linkLabel: 'Find Mediation Services' },
