...
const PROGRAMS = {
  ...
  saskatchewan: {
    ...
    programs: [
      ...
      { category: 'youth', name: 'Egadz Youth Centre', description: 'Free drop-in, meals, emergency shelter, outreach, and support for at-risk youth in Saskatoon.', url: 'https://www.egadz.ca/', phone: '306-931-6644' },
